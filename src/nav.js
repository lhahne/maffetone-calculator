export function initNav() {
  const navHTML = `
    <button id="nav-toggle" class="fixed top-6 right-6 z-50 p-2 text-white bg-slate-800 rounded-lg border border-white/10 hover:bg-slate-700 transition focus:outline-none focus:ring-2 focus:ring-sky-400" aria-label="Toggle Menu">
